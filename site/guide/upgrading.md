...
2. Support **live RPC v6 and event schema v37**. Wait for `rpc.handshake.accepted` before sending
...
Use the checked-in `schemas/live-rpc/v6/` bundle and the typed Python transport as implementation
