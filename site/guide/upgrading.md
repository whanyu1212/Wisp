...
2. Support **live RPC v7 and event schema v38**. Wait for `rpc.handshake.accepted` before sending
...
Use the checked-in `schemas/live-rpc/v7/` bundle and the typed Python transport as implementation
