...
- [5. Controlling side effects](crafting-agents/05-side-effects.md)
...
- [Upgrading to Wisp 0.2](guide/upgrading.md)
- [Staying in sync](guide/staying-in-sync.md)
- [Interfaces](guide/interfaces.md)
- [Python SDK](guide/sdk.md)
- [Providers and auth](guide/providers.md)
- [Tools and safety](guide/tools-and-safety.md)
- [Sessions](guide/sessions.md)
- [Context and compaction](guide/context-and-compaction.md)
...
- [SDK capability audit](reference/sdk-capability-audit.md)
- [Project file discovery](reference/project-files.md)
...
- [Rust terminal frontend boundary](architecture/rust-tui-boundary.md)
