...
def builtin_command_descriptors() -> tuple[CommandDescriptor, ...]:
    ...
    return (
        ...
        CommandDescriptor(
            name="name",
            title="Name session",
            description="Set or clear the current session's display name",
            category=CommandCategory.session,
            arguments=(CommandArgument("display-name", "Display name or --clear", required=True),),
            accepts_arguments=True,
            order=41,
        ),
        CommandDescriptor(
        ...
        CommandDescriptor(
            name="tree",
            title="Session tree",
            description="Browse the current session tree",
            category=CommandCategory.session,
            order=43,
        ),
        CommandDescriptor(
            name="unrevert",
            title="Restore session branch",
            description="Restore the previous session branch after navigation",
            category=CommandCategory.session,
            order=44,
        ),
        CommandDescriptor(
