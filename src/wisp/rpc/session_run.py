"""Session prompt, init, compact, and statistics execution for the RPC frontend."""
...
def start_rpc_init_command(
    ...
    *,
    ...
    try:
        instructions, target = _project_init_request(agent)
    ...
    return start_rpc_prompt_command(
        command,
        agent=agent,
        sessions=sessions,
        ...
        running_command_factory=running_command_factory,
        command_completed_factory=command_completed_factory,
    )
