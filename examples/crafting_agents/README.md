...
Runnable sources for the first two chapters of the [mdBook](../../site/crafting-agents/index.md).
...
calls; it does not mean the task succeeded. The second checkpoint prints the final
source before its temporary directory is removed.
...
strict type checking. The docs workflow also runs all three checkpoint commands before
building the book.
