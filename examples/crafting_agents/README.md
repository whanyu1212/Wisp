...
```bash
uv run pytest tests/docs/crafting/test_agents.py tests/docs/crafting/test_context.py tests/docs/crafting/test_providers.py tests/docs/crafting/test_side_effects.py
